...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            title: t('two_factor.modal.enabled.title'),
            description: t('two_factor.modal.enabled.description'),
    ...
    if (showVerificationStep.value) {
        return {
            title: t('two_factor.modal.verify.title'),
            description: t('two_factor.modal.verify.description'),
            buttonText: t('common.continue'),
        };
    }

    return {
        title: t('two_factor.modal.setup.title'),
        description: t('two_factor.modal.setup.description'),
        buttonText: t('common.continue'),
    };
});
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="bg-card relative px-2 py-1">{{
                                t('two_factor.modal.manual_entry')
                            }}</span>
                        </div>
